...
public class ProfileFragment extends Fragment{
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater,
        ...
        final Button signoutbtn=root.findViewById(R.id.button3);
        final TextView cpass = root.findViewById(R.id.cpass);
        profileImage= root.findViewById(R.id.imageView2);
        profileName=root.findViewById(R.id.uname);
        profileEmail=root.findViewById(R.id.mail);
